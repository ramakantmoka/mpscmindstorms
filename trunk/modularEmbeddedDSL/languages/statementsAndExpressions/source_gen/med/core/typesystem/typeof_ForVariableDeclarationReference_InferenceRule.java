  ...
  public void applyRule(final SNode reference, final TypeCheckingContext typeCheckingContext) {
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:2722db94-1dcc-4cd4-9566-13f53f67069f(med.core.typesystem)", "4739672646790522639", 0, intentionProvider);
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:2722db94-1dcc-4cd4-9566-13f53f67069f(med.core.typesystem)", "4739672646790499476", true), (SNode) typeCheckingContext.typeOf(SLinkOperations.getTarget(reference, "variable", false), "r:2722db94-1dcc-4cd4-9566-13f53f67069f(med.core.typesystem)", "4739672646790522644", true), _info_12389875345);
    }
  }

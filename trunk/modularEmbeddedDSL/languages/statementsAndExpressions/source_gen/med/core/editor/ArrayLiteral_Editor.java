...
public class ArrayLiteral_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_maey8r_b0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new ArrayLiteral_Editor.elementsListHandler_maey8r_b0(node, "elements", editorContext);
  ...
  private static class elementsListHandler_maey8r_b0 extends RefNodeListHandler {
    public elementsListHandler_maey8r_b0(SNode ownerNode, String childRole, EditorContext context) {

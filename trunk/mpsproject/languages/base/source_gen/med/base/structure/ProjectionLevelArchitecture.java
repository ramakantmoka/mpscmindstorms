...
public class ProjectionLevelArchitecture extends ProjectionLevel {
  public static final String concept = "med.base.structure.ProjectionLevelArchitecture";
  ...
  public static ProjectionLevelArchitecture newInstance(SModel sm, boolean init) {
    return (ProjectionLevelArchitecture)SModelUtil_new.instantiateConceptDeclaration("med.base.structure.ProjectionLevelArchitecture", sm, GlobalScope.getInstance(), init).getAdapter();
  }

...
public class ArrayLiteral_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_8106_0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new ArrayLiteral_Editor.elementsListHandler_8106_0(node, "elements", editorContext);
  ...
  private static class elementsListHandler_8106_0 extends RefNodeListHandler {
    public elementsListHandler_8106_0(SNode ownerNode, String childRole, EditorContext context) {

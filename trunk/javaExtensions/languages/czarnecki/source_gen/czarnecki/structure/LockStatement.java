...
public class LockStatement extends Statement {
  public static final String concept = "czarnecki.structure.LockStatement";
  ...
  public static LockStatement newInstance(SModel sm, boolean init) {
    return (LockStatement) SModelUtil_new.instantiateConceptDeclaration("czarnecki.structure.LockStatement", sm, GlobalScope.getInstance(), init).getAdapter();
  }

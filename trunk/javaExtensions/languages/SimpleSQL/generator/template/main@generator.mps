...
<model modelUID="r:f159fcfe-9bbb-457c-9f91-027df574c03f(SimpleSQL.generator.template.main@generator)">
  ...
  <node type="jetbrains.mps.lang.generator.structure.MappingConfiguration:2" id="2297501033533129072">
    ...
    <node role="reductionMappingRule:2" type="jetbrains.mps.lang.generator.structure.Reduction_MappingRule:2" id="2297501033533256502">
      ...
      <node role="ruleConsequence:2" type="jetbrains.mps.lang.generator.structure.InlineTemplate_RuleConsequence:2" id="2297501033533256504">
        <node role="templateNode:2" type="jetbrains.mps.gtext.structure.GItemList" id="2297501033533256506">
          <node role="item" type="jetbrains.mps.gtext.structure.GText" id="2297501033533256507">
            <property name="text" value="fname" />
            <node role="propertyMacro$property_attribute$text" type="jetbrains.mps.lang.generator.structure.PropertyMacro:2" id="2297501033533256508">
          ...
          <node role="item" type="jetbrains.mps.gtext.structure.GText" id="2297501033533256518">
            <property name="text" value="==" />
          </node>
          <node role="item" type="jetbrains.mps.gtext.structure.GItem" id="2297501033533256519">
            <node role="nodeMacro$attribute" type="jetbrains.mps.lang.generator.structure.CopySrcNodeMacro:2" id="2297501033533256521">
    ...
    <node role="reductionMappingRule:2" type="jetbrains.mps.lang.generator.structure.Reduction_MappingRule:2" id="2297501033533256530">
      ...
      <node role="ruleConsequence:2" type="jetbrains.mps.lang.generator.structure.InlineTemplate_RuleConsequence:2" id="2297501033533256532">
        <node role="templateNode:2" type="jetbrains.mps.gtext.structure.GItemList" id="2297501033533256534">
          <node role="item" type="jetbrains.mps.gtext.structure.GText" id="2297501033533256539">
            <property name="text" value="&quot;" />
          </node>
          <node role="item" type="jetbrains.mps.gtext.structure.GText" id="2297501033533256540">
            <property name="text" value="text" />
            <node role="propertyMacro$property_attribute$text" type="jetbrains.mps.lang.generator.structure.PropertyMacro:2" id="2297501033533256542">
          ...
          <node role="item" type="jetbrains.mps.gtext.structure.GText" id="2297501033533256541">
            <property name="text" value="&quot;" />
          </node>
        </node>
      </node>
  ...
  <node type="jetbrains.mps.gtext.structure.GDocument" id="2297501033533155061">
    <property name="documentName" value="sqloutput" />
    <property name="extension" value="txt" />
    <node role="item" type="jetbrains.mps.gtext.structure.GLine" id="2297501033533155064">
      <node role="item" type="jetbrains.mps.gtext.structure.GText" id="2297501033533155075">
        <property name="text" value="SELECT * FROM " />
      </node>
      <node role="item" type="jetbrains.mps.gtext.structure.GText" id="2297501033533155076">
        <property name="text" value="name" />
        <node role="propertyMacro$property_attribute$text" type="jetbrains.mps.lang.generator.structure.PropertyMacro:2" id="2297501033533155077">
      ...
      <node role="item" type="jetbrains.mps.gtext.structure.GText" id="2297501033533254297">
        <property name="text" value=" WHERE " />
        <node role="nodeMacro$attribute" type="jetbrains.mps.lang.generator.structure.IfMacro:2" id="2297501033533254299">
            ...
            <node role="body:2" type="jetbrains.mps.baseLanguage.structure.StatementList:3" id="2297501033533254301">
              <node role="statement:3" type="jetbrains.mps.baseLanguage.structure.ExpressionStatement:3" id="2297501033533256480">
                <node role="expression:3" type="jetbrains.mps.baseLanguage.structure.DotExpression:3" id="2297501033533256487">
                  ...
                  <node role="operation:3" type="jetbrains.mps.baseLanguage.collections.structure.IsNotEmptyOperation" id="2297501033533256491" />
                </node>
              </node>
            </node>
          </node>
      ...
      <node role="item" type="jetbrains.mps.gtext.structure.GItem" id="2297501033533155071">
        <node role="nodeMacro$attribute" type="jetbrains.mps.lang.generator.structure.CopySrcListMacro:2" id="2297501033533256493">
    ...
    <node role="rootTemplateAnnotation$attribute" type="jetbrains.mps.lang.generator.structure.RootTemplateAnnotation:2" id="2297501033533155063">
      <link role="applicableConcept:2" targetNodeId="1.2297501033532697327" resolveInfo="SelectStatement" />
    </node>
  </node>
</model>

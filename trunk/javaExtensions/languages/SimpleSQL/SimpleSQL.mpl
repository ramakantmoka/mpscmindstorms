...
<language namespace="SimpleSQL" uuid="d2aababe-cfd1-4ac7-b8c1-5533f964dadf" java-stubs-enabled="false" compileInMPS="true">
  ...
  <accessoryModels />
  <generators>
    <generator name="main" generatorUID="SimpleSQL#2297501033533129071" uuid="0a8d0536-c3bf-4852-9677-3c28bdfb4b03">
      <models>
        <modelRoot path="${language_descriptor}/generator/template" namespacePrefix="SimpleSQL.generator.template" />
      </models>
      <external-templates />
      <usedLanguages>

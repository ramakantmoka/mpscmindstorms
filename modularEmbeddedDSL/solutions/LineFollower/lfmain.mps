...
<model modelUID="r:87349ab3-9b12-4481-9a60-1d03a1d1532e(lfmain)">
  ...
  <node type="med.core.structure.Resource:9" id="5196379128660651509">
    ...
    <node role="modules:9" type="med.core.structure.ImplementationModule:9" id="5196379128660651513">
      ...
      <node role="contents:9" type="med.statemachine.structure.Statemachine" id="6790227271038808735">
        ...
        <property name="projMode" value="table" />
        ...
        <node role="states" type="med.statemachine.structure.State" id="6790227271038924457">
          ...
          <node role="transitions" type="med.statemachine.structure.Transition" id="5296414764970022304">
            ...
            <node role="featureDependencyAnnotation$attribute" type="med.features.structure.FeatureClause:4" id="5296414764970153973">
              <property name="isNew:4" value="false" />
              <node role="expression:4" type="med.features.structure.AtomicFE:4" id="684445375798122717">
                <link role="feature:4" targetNodeId="7680622939174614997" resolveInfo="bumper" />
              </node>
            </node>
          ...
          <node role="transitions" type="med.statemachine.structure.Transition" id="7348149346522524762">
            <link role="target" targetNodeId="5296414764970022306" resolveInfo="crash" />
            <node role="guard" type="med.core.structure.TrueLiteral:9" id="7348149346522524763" />
            <node role="trigger" type="med.statemachine.structure.EventTrigger" id="7348149346522524764">
              <link role="event" targetNodeId="6821937377367976841" resolveInfo="unblocked" />
            </node>
          </node>
        </node>
        <node role="states" type="med.statemachine.structure.State" id="5296414764970022306">
          ...
          <node role="transitions" type="med.statemachine.structure.Transition" id="7348149346523111015">
            <link role="target" targetNodeId="6790227271038924456" resolveInfo="initializing" />
            <node role="guard" type="med.core.structure.TrueLiteral:9" id="7348149346523111016" />
            <node role="trigger" type="med.statemachine.structure.EventTrigger" id="7348149346523111017">
              <link role="event" targetNodeId="6821937377367976827" resolveInfo="blocked" />
            </node>
          </node>
          <node role="transitions" type="med.statemachine.structure.Transition" id="4954657687992908256">
            <link role="target" targetNodeId="5296414764970022306" resolveInfo="crash" />
            <node role="guard" type="med.core.structure.TrueLiteral:9" id="4954657687992908257" />
            <node role="trigger" type="med.statemachine.structure.EventTrigger" id="4954657687992908258">
              <link role="event" targetNodeId="6821937377367976841" resolveInfo="unblocked" />
            </node>
          </node>
          <node role="transitions" type="med.statemachine.structure.Transition" id="4954657687992908259">
            <link role="target" targetNodeId="6790227271038924456" resolveInfo="initializing" />
            <node role="guard" type="med.core.structure.TrueLiteral:9" id="4954657687992908260" />
            <node role="trigger" type="med.statemachine.structure.EventTrigger" id="4954657687992908261">
              <link role="event" targetNodeId="5296414764970022303" resolveInfo="bumped" />
            </node>
          </node>
        </node>
  ...
  <node type="med.features.structure.FeatureDependencyConfiguration:4" id="5196379128662641904">
    ...
    <node role="features:4" type="med.features.structure.SimpleFeatureDeclaration:4" id="7680622939174614997">
      ...
      <property name="selected:4" value="true" />
    </node>

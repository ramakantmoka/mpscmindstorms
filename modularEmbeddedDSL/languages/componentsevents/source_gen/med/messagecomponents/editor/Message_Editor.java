...
public class Message_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_ok3mgi_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_ok3mgi_b0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createProperty_ok3mgi_b0(EditorContext editorContext, SNode node) {

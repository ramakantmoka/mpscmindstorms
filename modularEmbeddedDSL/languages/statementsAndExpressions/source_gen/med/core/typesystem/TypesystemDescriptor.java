...
public class TypesystemDescriptor extends BaseHelginsDescriptor {
  public TypesystemDescriptor() {
    ...
    {
      InferenceRule_Runtime inferenceRule = new typeof_ProcedureSignature_InferenceRule();
      this.myInferenceRules.add(inferenceRule);
    }
    {
    ...
    {
      InferenceRule_Runtime inferenceRule = new typeof_UInt8_InferenceRule();
      this.myInferenceRules.add(inferenceRule);
    }
    {
      InferenceRule_Runtime inferenceRule = new typeof_UInt16_InferenceRule();
      this.myInferenceRules.add(inferenceRule);
    }
    {
      InferenceRule_Runtime inferenceRule = new typeof_UInt32_InferenceRule();
      this.myInferenceRules.add(inferenceRule);
    }
    {
      InferenceRule_Runtime inferenceRule = new typeof_UInt64_InferenceRule();
      this.myInferenceRules.add(inferenceRule);
    }
    {
    ...
    {
      NonTypesystemRule_Runtime nonTypesystemRule = new noVoidOnRightSideOfAssignment_NonTypesystemRule();
      this.myNonTypesystemRules.add(nonTypesystemRule);
    }
    {
      NonTypesystemRule_Runtime nonTypesystemRule = new noVoidOnRightSideOfLocalVarDecl_NonTypesystemRule();
      this.myNonTypesystemRules.add(nonTypesystemRule);
    }
    {

...
public class NotExpression extends Expression {
  public static final String concept = "med.core.structure.NotExpression";
  ...
  public static NotExpression newInstance(SModel sm, boolean init) {
    return (NotExpression)SModelUtil_new.instantiateConceptDeclaration("med.core.structure.NotExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }

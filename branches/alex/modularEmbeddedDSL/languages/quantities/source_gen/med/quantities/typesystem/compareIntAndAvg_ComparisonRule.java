...
public class compareIntAndAvg_ComparisonRule extends ComparisonRule_Runtime {
  public compareIntAndAvg_ComparisonRule() {
  }

  public boolean areComparable(SNode node1, SNode node2) {

    if (SNodeOperations.getConceptDeclaration(SLinkOperations.getTarget(node1, "baseType", true)) == SNodeOperations.getConceptDeclaration(node2)) {
      return true;
    }
    return false;
  }

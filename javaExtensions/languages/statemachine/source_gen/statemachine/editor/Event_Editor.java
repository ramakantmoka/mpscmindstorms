...
public class Event_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_6350_0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Event_Editor.parameterListHandler_6350_0(node, "parameter", editorContext);
  ...
  private static class parameterListHandler_6350_0 extends RefNodeListHandler {
    public parameterListHandler_6350_0(SNode ownerNode, String childRole, EditorContext context) {

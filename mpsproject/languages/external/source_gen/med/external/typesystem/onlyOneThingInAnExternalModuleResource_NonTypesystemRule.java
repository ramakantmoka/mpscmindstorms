package med.external.typesystem;
        ...
        if (ListSequence.fromList(SLinkOperations.getTargets(resource, "modules", true)).count() > 1) {
          {
            ...
            typeCheckingContext.reportTypeError(resource, "if a resource contains an external module, nothing else can be in the resource", "r:202795d3-bacc-48e0-8afc-c254098b7868(med.external.typesystem)", "7647825645222488050", intentionProvider, errorTarget);
          }
        }
      }
    }

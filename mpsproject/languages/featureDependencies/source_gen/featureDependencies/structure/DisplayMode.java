...
public class DisplayMode extends BaseConcept {
  public static final String concept = "featureDependencies.structure.DisplayMode";
  ...
  public static DisplayMode newInstance(SModel sm, boolean init) {
    return (DisplayMode)SModelUtil_new.instantiateConceptDeclaration("featureDependencies.structure.DisplayMode", sm, GlobalScope.getInstance(), init).getAdapter();
  }

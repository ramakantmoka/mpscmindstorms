        ...
        public void run() {
          ...
          for (SNode a : ListSequence.fromList(SLinkOperations.getTargets(procedureCall, "actuals", true))) {
            ...
            SNode p = ListSequence.fromList(SLinkOperations.getTargets(procedure, "parameters", true)).toGenericArray(SNode.class)[idx];
            {
              ...
              typeCheckingContext.createEquation((SNode)typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:2722db94-1dcc-4cd4-9566-13f53f67069f(med.core.typesystem)", "2005811434196936628", true), (SNode)typeCheckingContext.typeOf(p, "r:2722db94-1dcc-4cd4-9566-13f53f67069f(med.core.typesystem)", "2005811434196936631", true), _nodeToCheck_1029348928467, null, "r:2722db94-1dcc-4cd4-9566-13f53f67069f(med.core.typesystem)", "2005811434196936626", intentionProvider);
            }
          }
        }
      }, "r:2722db94-1dcc-4cd4-9566-13f53f67069f(med.core.typesystem)", "2005811434196936593", false, false);
    }
  }
